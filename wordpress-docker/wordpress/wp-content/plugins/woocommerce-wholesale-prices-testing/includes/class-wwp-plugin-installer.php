	...
	class WWP_Plugin_Installer {
        ...
        public function download_and_activate_plugin( $plugin_slug ) {
            ...
            if ( ! current_user_can( 'install_plugins' ) || ! current_user_can( 'activate_plugins' ) ) {
                return new \WP_Error( 'permission_denied', __( 'You do not have sufficient permissions to install and activate plugins.', 'woocommerce-wholesale-prices-testing' ) );
            }

            // Check if the plugin is valid.
            if ( ! $this->_is_plugin_allowed_for_install( $plugin_slug ) ) {
                return new \WP_Error( 'wwp_plugin_not_allowed', __( 'The plugin is not valid.', 'woocommerce-wholesale-prices-testing' ) );
            }
            ...
            if ( is_plugin_active( $plugin_basename ) ) {
                return new \WP_Error( 'wwp_plugin_already_active', __( 'The plugin is already installed.', 'woocommerce-wholesale-prices-testing' ) );
            }
