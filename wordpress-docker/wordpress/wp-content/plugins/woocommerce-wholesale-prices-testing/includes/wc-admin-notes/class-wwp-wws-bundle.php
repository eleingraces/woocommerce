    ...
    class WWP_WWS_Bundle {
        ...
        public function wws_bundle_note() {
            ...
            try {
                ...
                $note->set_title( __( 'Wholesale Suite for WooCommerce', 'woocommerce-wholesale-prices-testing' ) );
                $note->set_content( $note_content );
                $note->set_content_data( (object) array() );
                $note->set_type( $note::E_WC_ADMIN_NOTE_INFORMATIONAL );
                $note->set_name( self::NOTE_NAME );
                $note->set_source( 'woocommerce-admin' );
                $note->add_action( 'features-pricing', __( 'See Features & Pricing', 'woocommerce-wholesale-prices-testing' ), $bundle_url, $note::E_WC_ADMIN_NOTE_ACTIONED, true );
                $note->save();
