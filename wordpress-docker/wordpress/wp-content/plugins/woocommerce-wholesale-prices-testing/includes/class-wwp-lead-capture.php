...
if ( ! class_exists( 'WWP_Lead_Capture' ) ) {

    /**
     * Model that houses logic related to Wholesale > Lead Capture Page
     *
     * @since 1.14
     */
    class WWP_Lead_Capture {
        ...
        public function register_lead_capture_page_menu() {
            ...
            if (
                ...
                add_submenu_page(
                    'wholesale-suite',
                    __( 'Lead Capture', 'woocommerce-wholesale-prices-testing' ),
                    __( 'Lead Capture', 'woocommerce-wholesale-prices-testing' ),
            ...
            if ( function_exists( 'wc_admin_connect_page' ) ) {
                wc_admin_connect_page(
                    array(
                        ...
                        'title'     => __( 'Wholesale Lead Capture', 'woocommerce-wholesale-prices-testing' ),
                    )
                );
            }
        }
