...
if ( ! class_exists( 'WWP_Helper_Functions' ) ) {
    ...
    final class WWP_Helper_Functions {
        ...
        public static function is_wwpp_active() {
            ...
            return self::is_plugin_active( 'woocommerce-wholesale-prices-testing-premium/woocommerce-wholesale-prices-testing-premium.bootstrap.php' ) && $wc_wholesale_prices_premium;
        }
        ...
        public static function is_wwp_installed() {
            ...
            $plugin_file = 'woocommerce-wholesale-prices-testing/woocommerce-wholesale-prices-testing.bootstrap.php';
        ...
        public static function is_wwpp_installed() {
            ...
            $plugin_file = 'woocommerce-wholesale-prices-testing-premium/woocommerce-wholesale-prices-testing-premium.bootstrap.php';
        ...
        public static function is_wwp_v2() {
            ...
            if ( self::is_plugin_active( 'woocommerce-wholesale-prices-testing/woocommerce-wholesale-prices-testing.bootstrap.php' ) ) {

                if ( ! function_exists( 'get_plugin_data' ) ) {
                    require_once ABSPATH . '/wp-admin/includes/plugin.php';
                }

                $wwp_data = get_plugin_data( WWP_PLUGIN_PATH . 'woocommerce-wholesale-prices-testing.bootstrap.php', false, false );
        ...
        public static function check_wws_plugin_min_version( $plugin, $version ) {
            ...
            switch ( $plugin ) {
                ...
                case 'wwpp':
                default:
                    if ( self::is_plugin_active( 'woocommerce-wholesale-prices-testing-premium/woocommerce-wholesale-prices-testing-premium.bootstrap.php' ) ) {
        ...
        public static function get_license_status_i18n( $status ) {
            ...
            switch ( $status ) {
                case 'active':
                    return __( 'Active', 'woocommerce-wholesale-prices-testing' );
                case 'disabled':
                    return __( 'Disabled', 'woocommerce-wholesale-prices-testing' );
                case 'invalid':
                    return __( 'Invalid', 'woocommerce-wholesale-prices-testing' );
                case 'expired':
                    return __( 'Expired', 'woocommerce-wholesale-prices-testing' );
            }
        }
