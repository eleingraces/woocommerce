...
if ( ! class_exists( 'WWP_REST_Wholesale_Roles_V1_Controller' ) ) {
    ...
    class WWP_REST_Wholesale_Roles_V1_Controller extends WC_REST_Controller {
        ...
        public function permissions_check( $request ) {
            ...
            return new WP_Error( 'wholesale_rest_role_permission_failed', __( "You don't have permission.", 'woocommerce-wholesale-prices-testing' ), array( 'status' => rest_authorization_required_code() ) );
        }
        ...
        public function get_item( $request ) {
            ...
            return new WP_Error( 'wholesale_rest_cannot_view', __( 'Item not found.', 'woocommerce-wholesale-prices-testing' ), array( 'status' => 400 ) );
        }
        ...
        public function update_item( $request ) {
            ...
            if ( ! empty( $role_key ) && isset( $this->wc_wholesale_prices->wwp_wholesale_roles->getAllRegisteredWholesaleRoles()[ $role_key ] ) ) {
                ...
                $result = array(
                    ...
                    'message' => sprintf( __( 'Wholesale Role %s has been updated.', 'woocommerce-wholesale-prices-testing' ), $role_key ),
            ...
            return new WP_Error( 'wholesale_rest_role_cannot_update', __( 'Item not found.', 'woocommerce-wholesale-prices-testing' ), array( 'status' => 400 ) );
        }
        ...
        public function delete_item( $request ) {
            return new WP_Error( 'wholesale_rest_role_cannot_delete', __( 'Item not found.', 'woocommerce-wholesale-prices-testing' ), array( 'status' => 400 ) );
        }
