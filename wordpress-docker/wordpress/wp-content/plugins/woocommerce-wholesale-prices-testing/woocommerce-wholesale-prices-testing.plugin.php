...
class WooCommerceWholeSalePrices {
    ...
    public function declare_hpos_compatibility() {
        if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
            \Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', 'woocommerce-wholesale-prices-testing/woocommerce-wholesale-prices-testing.bootstrap.php', true );
        }
    }
    ...
    public function declare_cart_checkout_blocks_incompatibility() {
        if ( class_exists( '\Automattic\WooCommerce\Utilities\FeaturesUtil' ) ) {
            \Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'cart_checkout_blocks', 'woocommerce-wholesale-prices-testing/woocommerce-wholesale-prices-testing.bootstrap.php', true );
        }
    }
