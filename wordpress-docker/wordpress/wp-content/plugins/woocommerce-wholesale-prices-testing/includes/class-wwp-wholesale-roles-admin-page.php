    ...
    class WWP_Wholesale_Roles_Admin_Page {
        ...
        public function register_wholesale_roles_admin_page_menu() {
            ...
            if ( ! WWP_Helper_Functions::is_plugin_active( 'woocommerce-wholesale-prices-testing-premium/woocommerce-wholesale-prices-testing-premium.bootstrap.php' ) ) {
                ...
                add_submenu_page(
                    'wholesale-suite',
                    __( 'Roles', 'woocommerce-wholesale-prices-testing' ),
                    __( 'Roles', 'woocommerce-wholesale-prices-testing' ),
        ...
        public function edit_wholesale_role( $role = null ) {
            ...
            if ( ! wp_doing_ajax() ||
                ...
                echo wp_json_encode(
                    array(
						'status'        => 'error',
						'error_message' => __( 'Security error. Cannot edit wholesale role.', 'woocommerce-wholesale-prices-testing' ),
                    )
                );
                wp_die();
            }
            ...
            if ( array_key_exists( $role['roleKey'], $wp_roles_arr ) ) {
                ...
                $response = array(
                    ...
                    'error_message' => sprintf( __( 'Specified Wholesale Role (%1$s) Does not Exist', 'woocommerce-wholesale-prices-testing' ), $role['roleKey'] ),
                );
            }
