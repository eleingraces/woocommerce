...
if ( ! class_exists( 'WWP_Products_CPT' ) ) {
    ...
    class WWP_Products_CPT {
        ...
        public function add_wholesale_price_column_to_product_cpt_listing( $columns ) {
            ...
            return array_slice( $columns, 0, $price_index + 1, true ) + array( 'wholesale_price' => __( 'Wholesale Price', 'woocommerce-wholesale-prices-testing' ) ) + array_slice( $columns, $price_index + 1, null, true );
        }
