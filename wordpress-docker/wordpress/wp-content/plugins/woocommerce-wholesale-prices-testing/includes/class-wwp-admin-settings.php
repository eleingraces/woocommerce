    ...
    class WWP_Admin_Settings {
        ...
        public function permission_admin_check( $request ) { // phpcs:ignore.
            ...
            if ( ! current_user_can( 'manage_woocommerce' ) ) {
                return new WP_Error( 'rest_forbidden', esc_html__( 'You do not have permission to save data.', 'woocommerce-wholesale-prices-testing' ), array( 'status' => 403 ) );
            }
        ...
        public function save_registered_settings( $request ) {
            ...
            $settings_messages = array(
                'status'  => 'success',
                'message' => esc_html__( 'Settings saved successfully.', 'woocommerce-wholesale-prices-testing' ),
            );
            if ( ! empty( $params ) ) {
                $options = array();
        ...
        public function trigger_action( $request ) {
            ...
            $settings_messages = array(
                'status'  => 'success',
                'message' => esc_html__( 'Cache cleared successfully.', 'woocommerce-wholesale-prices-testing' ),
            );
        ...
        public function get_details() {
            $details = array(
                ...
                'title' => __( 'Settings', 'woocommerce-wholesale-prices-testing' ),
            );
        ...
        private function _default_tabs() {
            ...
            $settings['wholesale_prices'] = array(
                'label' => __( 'Wholesale Prices', 'woocommerce-wholesale-prices-testing' ),
                'child' => array(),
            );
            ...
            $settings['wholesale_prices']['child']['general'] = array(
                'sort'                => 1,
                'key'                 => 'general',
                'label'               => __( 'General', 'woocommerce-wholesale-prices-testing' ),
                'sections'            => array(
                    'order_requirements' => array(
                        'label' => __( 'Wholesale Prices Settings', 'woocommerce-wholesale-prices-testing' ),
                        'desc'  => '',
                    ),
                ),
            ...
            $settings['wholesale_prices']['child']['price'] = array(
                'sort'     => 2,
                'key'      => 'price',
                'label'    => __( 'Price', 'woocommerce-wholesale-prices-testing' ),
                'sections' => array(
                    'price_options'         => array(
                        'label' => __( 'Price Options', 'woocommerce-wholesale-prices-testing' ),
                        'desc'  => '',
                    ),
                    'box_for_non_wholesale' => array(
                        'label'             => __( 'Show Wholesale Prices Box For Non Wholesale Customers', 'woocommerce-wholesale-prices-testing' ),
                        'desc'              => '',
            ...
            $settings['wholesale_prices']['child']['tax'] = array(
                'sort'               => 3,
                'key'                => 'tax',
                'label'              => __( 'Tax', 'woocommerce-wholesale-prices-testing' ),
                'sections'           => array(
                    'tax_options'     => array(
                        'label' => __( 'Tax Options', 'woocommerce-wholesale-prices-testing' ),
                        'desc'  => '',
                    ),
                    'tax_exp_mapping' => array(
                        'label' => __( 'Wholesale Role / Tax Exemption Mapping', 'woocommerce-wholesale-prices-testing' ),
                        'desc'  => $tax_exp_mapping_dec,
                    ),
                    'tax_cls_mapping' => array(
                        'label' => __( 'Wholesale Role / Tax Class Mapping', 'woocommerce-wholesale-prices-testing' ),
            ...
            $settings['wholesale_prices']['child']['admin_roles'] = array(
                'sort'     => 4,
                'key'      => 'admin_roles',
                'label'    => __( 'Admin Roles', 'woocommerce-wholesale-prices-testing' ),
                'sections' => array(
                    'admin_roles_options' => array(
                        'label' => __( 'Admin Roles', 'woocommerce-wholesale-prices-testing' ),
                        'desc'  => __( 'Manage the roles that can access the Wholesale dashboard and settings.', 'woocommerce-wholesale-prices-testing' ),
                    ),
                ),
            );
            ...
            $settings['wholesale_prices']['child']['help'] = array(
                'sort'     => 5,
                'key'      => 'help',
                'label'    => __( 'Help', 'woocommerce-wholesale-prices-testing' ),
                'sections' => array(
                    'shipping_options' => array(
                        'label' => __( 'Help Options', 'woocommerce-wholesale-prices-testing' ),
            ...
            $settings['wholesale_prices']['child']['license'] = array(
                'sort'     => 6,
                'key'      => 'license',
                'label'    => __( 'License', 'woocommerce-wholesale-prices-testing' ),
            ...
            $settings['wholesale_prices']['child']['upgrade'] = array(
                'sort'            => 7,
                'key'             => 'upgrade',
                'label'           => __( 'Upgrade To Premium', 'woocommerce-wholesale-prices-testing' ),
                'sections'        => array(
        ...
        private function general_tab_controls() {
            ...
            if ( 'yes' !== $wwp_anonymous_data_val ) {
                ...
                $general_controls['order_requirements'][] = array(
					'type'        => 'checkbox',
					'label'       => __( 'Allow Usage Tracking', 'woocommerce-wholesale-prices-testing' ),
					'id'          => 'wwp_anonymous_data',
					'input_label' => __( 'By allowing us to track usage data we can better help you because we know with which WordPress configurations, themes and plugins we should test.', 'woocommerce-wholesale-prices-testing' ),
					'multiple'    => false,
            ...
            $general_controls['order_requirements'][] = array(
				'type'        => 'checkbox',
				'label'       => __( 'Disable Coupons For Wholesale Users', 'woocommerce-wholesale-prices-testing' ),
				'id'          => 'wwpp_settings_disable_coupons_for_wholesale_users',
				'input_label' => __( 'Globally turn off coupons functionality for customers with a wholesale user role.', 'woocommerce-wholesale-prices-testing' ),
				'multiple'    => false,
				'description' => __( 'This applies to all customers with a wholesale role.', 'woocommerce-wholesale-prices-testing' ),
        ...
        private function prices_tab_controls() {
            ...
            $prices_controls['price_options'] = array(
                array(
                    'type'        => 'text',
                    'label'       => __( 'Wholesale Price Text', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwpp_settings_wholesale_price_title_text',
                    'default'     => $settings_wholesale_price_title_text,
                    'description' => __( 'The text shown immediately before the wholesale price. Default is "Wholesale Price: "', 'woocommerce-wholesale-prices-testing' ),
                ),
                array(
                    'type'        => 'checkbox',
                    'label'       => __( 'Hide Retail Price', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwpp_settings_hide_original_price',
                    'input_label' => __( 'Hide retail price instead of showing a crossed out price if a wholesale price is present.', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'    => false,
                    'default'     => $settings_hide_original_price,
                ),
                array(
                    'type'          => 'checkbox',
                    'label'         => __( 'Always Use Regular Price', 'woocommerce-wholesale-prices-testing' ),
                    'id'            => 'wwpp_settings_explicitly_use_product_regular_price_on_discount_calc_dummy',
                    'input_label'   => __( 'When calculating the wholesale price by using a percentage (global discount % or category based %) always ensure the Regular Price is used and ignore the Sale Price if present.', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'      => false,
                ...
                array(
                    'type'     => 'select',
                    'label'    => __( 'Variable Product Price Display', 'woocommerce-wholesale-prices-testing' ),
                    'desc_tip' => __( 'Specify the format in which variable product prices are displayed. Only for wholesale customers.', 'woocommerce-wholesale-prices-testing' ),
                ...
                array(
                    'type'        => 'checkbox',
                    'label'       => __( 'Hide Wholesale Price on Admin Product Listing', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwpp_hide_wholesale_price_on_product_listing',
                    'input_label' => __( 'If checked, hides wholesale price per wholesale role on the product listing on the admin page.', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'    => false,
                    'default'     => $wholesale_price_on_product_listing,
                ),
                array(
                    'type'        => 'checkbox',
                    'label'       => __( 'Hide Price and Add to Cart button', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_hide_price_add_to_cart',
                    'input_label' => __( 'If checked, hides price and add to cart button for visitors.', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'    => false,
                    'default'     => $hide_price_add_to_cart,
                ),
                array(
                    'type'        => 'textarea',
                    'label'       => __( 'Price and Add to Cart Replacement Message', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_price_and_add_to_cart_replacement_message',
                    'description' => __( 'This message is only shown if <b>Hide Price and Add to Cart button</b> is enabled. "Login to see prices" is the default message.', 'woocommerce-wholesale-prices-testing' ),
            ...
            $wwp_price_settings_register_text                       = ( $wwp_wwlc_is_active ) ? $wwp_price_settings_register_text : __( 'Click here to register as a wholesale customer', 'woocommerce-wholesale-prices-testing' );
            ...
            $prices_controls['box_for_non_wholesale'] = array(
                array(
                    'type'        => 'switch',
                    'label'       => __( 'Show Wholesale Price to non-wholesale users', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_prices_settings_show_wholesale_prices_to_non_wholesale',
                    'description' => __( 'If checked, displays the wholesale price on the front-end to entice non-wholesale customers to register as wholesale customers. This is only shown for guest, customers, administrator, and shop managers.', 'woocommerce-wholesale-prices-testing' ),
                    'options'     => array(
                        'yes' => __( 'Enabled', 'woocommerce-wholesale-prices-testing' ),
                        'no'  => __( 'Disabled', 'woocommerce-wholesale-prices-testing' ),
                    ),
                    'default'     => $prices_settings_show_wholesale_prices_to_non_wholesale,
                ),
                array(
                    'type'        => 'checkbox',
                    'label'       => __( 'Locations', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_non_wholesale_show_in_shop',
                    'input_label' => __( 'Shop Archives', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'    => false,
                ...
                array(
                    ...
                    'input_label' => __( 'Single Product', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'    => false,
                ...
                array(
                    ...
                    'input_label' => __( 'Wholesale Order Form', 'woocommerce-wholesale-prices-testing' ),
                ...
                array(
                    'type'      => 'text',
                    'label'     => __( 'Click to See Wholesale Prices Text', 'woocommerce-wholesale-prices-testing' ),
                    'id'        => 'wwp_see_wholesale_prices_replacement_text',
                    'default'   => $wwp_see_wholesale_prices_replacement_text,
                    'desc_tip'  => __( 'The "Click to See Wholesale Prices Text" seen in the frontpage.', 'woocommerce-wholesale-prices-testing' ),
                    'hide'      => $dependencies_display,
                    'condition' => array(
                        array(
                            'key'   => 'wwp_prices_settings_show_wholesale_prices_to_non_wholesale',
                ...
                array(
                    'type'      => 'select',
                    'label'     => __( 'Wholesale Roles(s)', 'woocommerce-wholesale-prices-testing' ),
                    'id'        => 'wwp_non_wholesale_wholesale_role_select2',
                    'default'   => array( 'wholesale_customer' ),
                    'options'   => array(
                        'wholesale_customer' => __( 'Wholesale Customer', 'woocommerce-wholesale-prices-testing' ),
                    ),
                    'desc_tip'  => __( 'The selected wholesale roles and pricing that should show to non-wholesale customers on the front end.', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'  => true,
                    'hide'      => $dependencies_display,
                    'condition' => array(
                        array(
                ...
                array(
                    'type'              => 'text',
                    'label'             => __( 'Register Text', 'woocommerce-wholesale-prices-testing' ),
                    'id'                => 'wwp_price_settings_register_text',
                    'default'           => $wwp_price_settings_register_text,
                    'desc_tip'          => __( 'This text is linked to the defined registration page in WooCommerce Wholesale Lead Capture settings.', 'woocommerce-wholesale-prices-testing' ),
                    'hide'              => $dependencies_display,
                    'condition'         => array(
                        array(
                            'key'   => 'wwp_prices_settings_show_wholesale_prices_to_non_wholesale',
        ...
        private function tax_tab_controls() {
            ...
            $tax_controls['tax_options'] = array(
                array(
                    'type'        => 'checkbox',
                    'label'       => __( 'Tax Exemption', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_settings_tax_exempt_wholesale_users',
                    'input_label' => __( 'Do not apply tax to all wholesale roles', 'woocommerce-wholesale-prices-testing' ),
                    'description' => __( 'Removes tax for all wholesale roles. All wholesale prices will display excluding tax throughout the store, cart and checkout. The display settings below will be ignored.', 'woocommerce-wholesale-prices-testing' ),
                    'multiple'    => false,
                    'default'     => 'no',
                ...
                array(
                    'type'        => 'select',
                    'label'       => __( 'Display Prices in the Shop', 'woocommerce-wholesale-prices-testing' ),
                    ...
                    'description' => __( 'Choose how wholesale roles see all prices throughout your shop pages.', 'woocommerce-wholesale-prices-testing' ),
                ...
                array(
                    'type'        => 'select',
                    'label'       => __( 'Display Prices During Cart and Checkout', 'woocommerce-wholesale-prices-testing' ),
                    ...
                    'description' => __( 'Choose how wholesale roles see all prices on the cart and checkout pages.', 'woocommerce-wholesale-prices-testing' ),
                ...
                array(
                    'type'        => 'text',
                    'label'       => __( 'Override Regular Price Suffix', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_settings_override_price_suffix_regular_price',
                    'description' => __( 'Override the price suffix on regular prices for wholesale users.', 'woocommerce-wholesale-prices-testing' ),
                ...
                array(
                    'type'        => 'text',
                    'label'       => __( 'Wholesale Price Suffix', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_settings_override_price_suffix',
                    'description' => __( 'Set a specific price suffix specifically for wholesale prices.', 'woocommerce-wholesale-prices-testing' ),
                    'desc_tip'    => __( 'Make this blank to use the default price suffix. You can also use prices substituted here using one of the following {price_including_tax} and {price_excluding_tax}.', 'woocommerce-wholesale-prices-testing' ),
                    'default'     => '',
                    'pro'         => 'upgrade_suffix',
                ),
        ...
        public function admin_roles_tab_controls() {
            ...
            $roles_controls['admin_roles_options'] = array(
                array(
                    'type'        => 'select',
                    'label'       => __( 'Allowed roles', 'woocommerce-wholesale-prices-testing' ),
                    'id'          => 'wwp_roles_allowed_dashboard_access',
                    'multiple'    => true,
                    'options'     => $registered_roles,
                    'default'     => ! empty( $allowed_roles ) ? $allowed_roles : array(),
                    'description' => __( 'Select the user roles allowed to access the Wholesale admin dashboard. Administrator and Shop manager are allowed by default.', 'woocommerce-wholesale-prices-testing' ),
                ),
            );
        ...
        private function upgrade_tab_controls() {
                ...
                array(
                    ...
                    'fields'  => array(
                        ...
                        array(
                            ...
                            'tag'     => 'h2',
                            'content' => __( 'Free vs Premium', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'paragraph',
                            'id'      => 'wwp_paragraph_upgrade',
                            'classes' => 'wwp-paragraph-upgrade',
                            'content' => __( 'If you are serious about growing your wholesale sales within your WooCommerce store then the Premium add-on to the free WooCommerce Wholesale Prices plugin that you are currently using can help you.', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'       => 'table',
                            ...
                            'fields'     => array(
                                array(
                                    'title'     => __( 'Features', 'woocommerce-wholesale-prices-testing' ),
                                    'dataIndex' => 'features',
                                    'key'       => 'features',
                                ),
                                array(
                                    'title'     => __( 'Free Plugin', 'woocommerce-wholesale-prices-testing' ),
                                    'dataIndex' => 'free_plugin',
                                    'key'       => 'free_plugin',
                                ),
                                array(
                                    'title'     => __( 'Premium Add-on', 'woocommerce-wholesale-prices-testing' ),
                            ...
                            'data'       => array(
                                array(
                                    'key'           => '1',
                                    'features'      => __( 'Flexible wholesale pricing', 'woocommerce-wholesale-prices-testing' ),
                                    'free_plugin'   => __( '<span class="dashicons dashicons-no"></span> Not available. Only basic wholesale pricing at the product level allowed.', 'woocommerce-wholesale-prices-testing' ),
                                    'premium_addon' => __( '<span class="dashicons dashicons-yes-alt"></span> Set wholesale pricing at the global (%), category (%) or the product level. Also includes quantity based pricing.', 'woocommerce-wholesale-prices-testing' ),
                                ),
                                array(
                                    'key'           => '2',
                                    'features'      => __( 'Product visibility control', 'woocommerce-wholesale-prices-testing' ),
                                    'free_plugin'   => __( '<span class="dashicons dashicons-no"></span> Not available', 'woocommerce-wholesale-prices-testing' ),
                                    'premium_addon' => __( '<span class="dashicons dashicons-yes-alt"></span> Make products "Wholesale Only", hide "Retail Only" products from wholesale customers, create variations that are "Wholesale Only".', 'woocommerce-wholesale-prices-testing' ),
                                ),
                                array(
                                    'key'           => '3',
                                    'features'      => __( 'Multiple wholesale role levels', 'woocommerce-wholesale-prices-testing' ),
                                    'free_plugin'   => __( '<span class="dashicons dashicons-no"></span> Not available. Only one wholesale role.', 'woocommerce-wholesale-prices-testing' ),
                                    'premium_addon' => __( '<span class="dashicons dashicons-yes-alt"></span> Add multiple wholesale role levels and use them to manage wholesale pricing, shipping mapping, payment mapping, tax exemption, order minimums and more.', 'woocommerce-wholesale-prices-testing' ),
                                ),
                                array(
                                    'key'           => '4',
                                    'features'      => __( 'Advanced tax control', 'woocommerce-wholesale-prices-testing' ),
                                    'free_plugin'   => __( '<span class="dashicons dashicons-no"></span> Not available', 'woocommerce-wholesale-prices-testing' ),
                                    'premium_addon' => __( '<span class="dashicons dashicons-yes-alt"></span> Fine grained control over price tax display for wholesale, tax exemptions per user role and more.', 'woocommerce-wholesale-prices-testing' ),
                                ),
                                array(
                                    'key'           => '5',
                                    'features'      => __( 'Shipping method mapping', 'woocommerce-wholesale-prices-testing' ),
                                    'free_plugin'   => __( '<span class="dashicons dashicons-no"></span> Not available', 'woocommerce-wholesale-prices-testing' ),
                                    'premium_addon' => __( '<span class="dashicons dashicons-yes-alt"></span> Manage which shipping methods wholesale customers can see and use compared to retail customers.', 'woocommerce-wholesale-prices-testing' ),
                                ),
                                array(
                                    'key'           => '6',
                                    'features'      => __( 'Payment gateway mapping', 'woocommerce-wholesale-prices-testing' ),
                                    'free_plugin'   => __( '<span class="dashicons dashicons-no"></span> Not available', 'woocommerce-wholesale-prices-testing' ),
                                    'premium_addon' => __( '<span class="dashicons dashicons-yes-alt"></span> Manage which payment gateways wholesale customers can see and use compared to retail customers.', 'woocommerce-wholesale-prices-testing' ),
                                ),
                                array(
                                    'key'           => '7',
                                    'features'      => __( 'Set product and order minimums', 'woocommerce-wholesale-prices-testing' ),
                                    'free_plugin'   => __( '<span class="dashicons dashicons-no"></span> Not available', 'woocommerce-wholesale-prices-testing' ),
                                    'premium_addon' => __( '<span class="dashicons dashicons-yes-alt"></span> Use product minimums and order minimums to ensure wholesale customers are meeting requirements.', 'woocommerce-wholesale-prices-testing' ),
                                ),
                            ),
                        ),
                        array(
                            ...
                            'content' => __( '+100\'s of other premium wholesale features', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'         => 'button',
                            'id'           => 'wwp_feature_list_btn',
                            'classes'      => 'wwp-feature-custom-btn',
                            'button_label' => __( 'See the full feature list', 'woocommerce-wholesale-prices-testing' ),
                            'link'         => esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'upgradepagewwppbutton' ) ),
                            'external'     => true,
                        ),
                    ),
                ),
            ...
            $wws_installed_label = array(
                ...
                'content' => __( '<em><span class="dashicons dashicons-yes-alt"></span> Installed<em>', 'woocommerce-wholesale-prices-testing' ),
            ...
            $wwp_wwpp_installed_label = array(
                'type'         => 'button',
                'id'           => 'wwp_bundle_link1',
                'button_label' => __( 'Learn more about Prices Premium', 'woocommerce-wholesale-prices-testing' ),
                'link'         => esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'upgradepagewwpplearnmore' ) ),
                'external'     => true,
            ...
            $wwp_wwof_installed_label = array(
                'type'         => 'button',
                'id'           => 'wwp_bundle_link2',
                'button_label' => __( 'Learn more about Order Form', 'woocommerce-wholesale-prices-testing' ),
            ...
            $wwp_wwlc_installed_label = array(
                'type'         => 'button',
                'id'           => 'wwp_bundle_link3',
                'button_label' => __( 'Learn more about Lead Capture', 'woocommerce-wholesale-prices-testing' ),
            ...
            $wwp_wpay_installed_label = array(
                'type'         => 'button',
                'id'           => 'wwp_bundle_link4',
                'button_label' => __( 'Learn more about Wholesale Payments', 'woocommerce-wholesale-prices-testing' ),
                ...
                array(
                    ...
                    'fields'  => array(
                        array(
                            ...
                            'classes' => 'wwp-heading-upgrade',
                            'tag'     => 'h2',
                            'content' => __( 'Wholesale Suite Bundle', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'paragraph',
                            'id'      => 'wwp_paragraph_upgrade2',
                            'classes' => 'wwp-paragraph-upgrade',
                            'content' => __( 'Everything you need to sell to wholesale customers in WooCommerce. The most complete wholesale solution for building wholesale sales into your existing WooCommerce driven store.', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'heading',
                            ...
                            'tag'     => 'h3',
                            'content' => __( 'WooCommerce Wholesale Prices Premium', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'paragraph',
                        ...
                        array(
                            ...
                            'tag'     => 'h3',
                            'content' => __( 'WoWooCommerce Wholesale Order Form', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'paragraph',
                        ...
                        array(
                            ...
                            'tag'     => 'h3',
                            'content' => __( 'WooCommerce Wholesale Lead Capture', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'paragraph',
                        ...
                        array(
                            ...
                            'tag'     => 'h3',
                            'content' => __( 'WooCommerce Wholesale Payments', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'paragraph',
                            ...
                            'content' => __( 'Streamline your wholesale payment processes with flexible payment options tailored for wholesale customers. Offer multiple payment gateways, enforce minimum order amounts for specific gateways, and provide payment terms that suit your wholesale business. Improve cash flow management with partial payments, deposits, and custom payment deadlines. Empower your customers with a seamless checkout experience designed for wholesale transactions.', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'    => 'image',
                        ...
                        array(
                            ...
                            'classes' => 'wwp-paragraph-feature',
                            'content' => __( 'The WooCommerce extensions to grow your wholesale business', 'woocommerce-wholesale-prices-testing' ),
                        ),
                        array(
                            'type'         => 'button',
                            'id'           => 'wwp_full_bundle_btn',
                            'classes'      => 'wwp-feature-custom-btn',
                            'button_label' => __( 'See the full bundle now', 'woocommerce-wholesale-prices-testing' ),
        ...
        public function group_settings_group_save( $options ) {
            ...
            if ( ! array_key_exists( $discount_mapping['wholesale_role'], $saved_discount_mapping ) ) {
                ...
                $response = array(
                    'status'  => 'error',
                    'message' => __( 'Duplicate Entry, Entry Already Exists', 'woocommerce-wholesale-prices-testing-premium' ),
                );
            }
        ...
        public function group_settings_group_delete( $options ) {
            ...
            if ( array_key_exists( $wholesale_role, $saved_discount_mapping ) ) {
                ...
                $response = array(
                    'status'        => 'error',
                    'error_message' => __( 'Entry to be deleted does not exist', 'woocommerce-wholesale-prices-testing-premium' ),
                );
            }
        ...
        public function group_settings_group_edit( $options ) {
            ...
            if ( array_key_exists( $discount_mapping['wholesale_role'], $saved_discount_mapping ) ) {
                ...
                $response = array(
                    'status'        => 'error',
                    'error_message' => __( 'Entry to be edited does not exist', 'woocommerce-wholesale-prices-testing-premium' ),
                );
            }
            ...
            if ( current_user_can( 'manage_woocommerce' ) && get_option( 'wwp_admin_notice_new_settings_hide' ) !== 'yes' && filter_input( INPUT_GET, 'page', FILTER_SANITIZE_FULL_SPECIAL_CHARS ) === 'wc-settings' ) {
                ...
                ?>
                    <div class="updated notice wwp-new-settings-notice">
                        ...
                        <p><?php esc_html_e( 'Hey there! We recently moved the settings pages for all Wholesale Suite plugins to the Wholesale menu. You\'ll now find them under Wholesale->Settings.', 'woocommerce-wholesale-prices-testing' ); ?>
                        <div class="wwp-new-settings-action-links">
                            <a href="<?php echo esc_url( $settings_page ); ?>" class="wwp-new-settings-take-btn">
                                <?php esc_html_e( 'I understand - take me there', 'woocommerce-wholesale-prices-testing' ); ?>
                            </a>
                            <a href="javascript:void(0);" class="wwp-new-settings-dismiss">
                                <?php esc_html_e( 'Dismiss', 'woocommerce-wholesale-prices-testing' ); ?>
                            </a>
                        </div>
                    </div>
                <?php
