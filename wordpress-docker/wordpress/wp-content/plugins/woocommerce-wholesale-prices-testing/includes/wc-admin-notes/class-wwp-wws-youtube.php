...
if ( ! class_exists( 'WWP_WWS_Youtube' ) ) {

    /**
     * Class WWP_WWS_Youtube.
     *
     * This class adds a WC Admin Note to follow WWS Youtube channel.
     *
     * @since 1.11.5
     */
    class WWP_WWS_Youtube {
        ...
        public function follow_wws_youtube() {
            ...
            try {
                ...
                $note->set_title( __( 'Follow Wholesale Suite on Youtube', 'woocommerce-wholesale-prices-testing' ) );
                $note->set_content( $note_content );
                $note->set_content_data( (object) array() );
                $note->set_type( $note::E_WC_ADMIN_NOTE_INFORMATIONAL );
                $note->set_name( self::NOTE_NAME );
                $note->set_source( 'woocommerce-admin' );
                $note->add_action( 'wws-youtube', __( 'Wholesale Suite Youtube Channel', 'woocommerce-wholesale-prices-testing' ), $wws_youtube, $note::E_WC_ADMIN_NOTE_ACTIONED, true );
                $note->save();
