    ...
    class WWP_Script_Loader { // phpcs:ignore
        ...
        public function load_back_end_styles_and_scripts( $handle ) {
            ...
            if ( is_admin() && current_user_can( 'manage_options' ) && get_option( WWP_SHOW_REQUEST_REVIEW ) === 'yes' && ( 'review-later' === $review_response || empty( $review_response ) ) ) {
                ...
                if ( WWP_Helper_Functions::is_wwpp_active() ) {
                    ...
                    ?>
                    <p><?php esc_html_e( 'Thanks for using our free WooCommerce Wholesale Prices plugin - we hope you are enjoying it so far.', 'woocommerce-wholesale-prices-testing' ); ?></p>
                    <p><?php esc_html_e( 'We\'d really appreciate it if you could take a few minutes to write a 5-star review of our Wholesale Prices plugin on WordPress.org!', 'woocommerce-wholesale-prices-testing' ); ?></p>
                    <p><?php esc_html_e( 'Your comment will go a long way to helping us grow and giving new users the confidence to give us a try.', 'woocommerce-wholesale-prices-testing' ); ?></p>
                    <p><?php esc_html_e( 'Thanks in advance, we are looking forward to reading it!', 'woocommerce-wholesale-prices-testing' ); ?></p>
                    <?php
                }
                ...
                wp_localize_script(
                    ...
                    array(
						...
						'msg'         => $msg,
						'review_link' => 'https://wordpress.org/support/plugin/woocommerce-wholesale-prices-testing/reviews/?filter=5#new-post',
            ...
            if ( in_array( $screen->id, array( 'edit-product' ), true ) ) {
                ...
                wp_localize_script(
                    ...
                    array(
						...
						'i18n_prompt_message' => __( 'Enter a value (leave blank to remove pricing)', 'woocommerce-wholesale-prices-testing' ),
                    )
                );
                ...
                wp_localize_script(
                    ...
                    array(
						...
						'i18n_discount_greater_than_100_percent_error' => __( 'Please enter in a value not greater than 100 percent.', 'woocommerce-wholesale-prices-testing' ),
						'i18n_discount_less_than_0_percent_error' => __( 'Please enter in a value not less than 0 percent', 'woocommerce-wholesale-prices-testing' ),
                    )
                );
                    ...
                    wp_localize_script(
                        ...
                        array(
							...
							'wholesale_prices'     => array(
								'title' => '<h4>' . __( 'Upgrade For Additional Wholesale Price Levels', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
								'msg'   => '<p>' . __(
								...
								'link'  => esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'wwpproducteditadditionalprices' ) ),
							),
							'product_visibility'   => array(
								'title' => '<h4>' . __( 'Upgrade For Product Visibility Features', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
								'msg'   => '<p>' . __(
								...
								'link'  => esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'wwpproducteditproductvisibility' ) ),
							),
                            'wholesale_sale_price' => array(
								'title' => '<h4>' . __( 'Upgrade For Wholesale Sale Price Features', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
								'msg'   => '<p>' . __(
							...
							'button_text'          => __( 'See Features & Pricing', 'woocommerce-wholesale-prices-testing' ),
							'bonus_text'           => sprintf(
                                // translators: 1. Opening bold tag, 2. Opening green text tag, 3. Closing span tag, 4. Closing paragraph tag.
                                __( '%1$sBonus:%3$s Wholesale Prices lite users get %2$s50&#37; off regular price%3$s automatically applied at checkout.%4$s', 'woocommerce-wholesale-prices-testing' ),
            ...
            if (
                ...
                wp_localize_script(
                    ...
                    array(
						'i18n_yes' => __( 'Yes', 'woocommerce-wholesale-prices-testing' ),
						'i18n_no'  => __( 'No', 'woocommerce-wholesale-prices-testing' ),
                    )
                );
                ...
                wp_localize_script(
                    ...
                    array(
						'i18n_enter_role_name'          => __( 'Please Enter Role Name', 'woocommerce-wholesale-prices-testing' ),
						'i18n_error_wholesale_form'     => __( 'Error in Wholesale Form', 'woocommerce-wholesale-prices-testing' ),
						'i18n_enter_role_key'           => __( 'Please Enter Role Key', 'woocommerce-wholesale-prices-testing' ),
						'i18n_role_successfully_edited' => __( 'Wholesale Role Successfully Edited', 'woocommerce-wholesale-prices-testing' ),
						'i18n_successfully_edited_role' => __( 'Successfully Edited Role', 'woocommerce-wholesale-prices-testing' ),
						'i18n_failed_edit_role'         => __( 'Failed to Edit Wholesale Role', 'woocommerce-wholesale-prices-testing' ),
            ...
            if ( strpos( $screen->id, 'wws-about-page' ) !== false ) {
                ...
                wp_localize_script(
                    ...
                    array(
                        ...
                        'i18n_installed_text' => __( 'Installed', 'woocommerce-wholesale-prices-testing' ),
                        'i18n_install_text'   => __( 'Install Plugin', 'woocommerce-wholesale-prices-testing' ),
                    )
                );
            }
                    ...
                    switch ( $_GET['section'] ) { // phpcs:ignore
                        case 'wwpp_setting_price_section':
                            ...
                            wp_localize_script(
                                ...
                                array(
									...
									'use_regular_price' => array(
										'title' => '<h4>' . __( 'Define Prices By Percentage Globally Or On Categories', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
										'msg'   => '<p>' . __(
										...
										'link'  => esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'wwppricesettingsalwaysuseregularwwpplink' ) ),
									),
									'variable_product_price_display' => array(
										'title' => '<h4>' . __( 'Change How Variable Product Prices Are Displayed', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
										'msg'   => '<p>' . __(
                            ...
                            Access this optimization option and more in the WooCommerce Wholesale Prices Premium plugin.',
										...
										'link'  => esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'wwppricesettingsvariabledisplaywwpplink' ) ),
									),
									'button_text'       => __( 'See Features & Pricing', 'woocommerce-wholesale-prices-testing' ),
                                )
                            );
                        ...
                        case 'wwpp_setting_tax_section':
                            ...
                            wp_localize_script(
                                ...
                                array(
									'images_url'       => WWP_IMAGES_URL,
									'tax_exemption'    => array(
										'title' => '<h4>' . __( 'Upgrade To Wholesale Suite For Tax Exemption', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
										'msg'   => sprintf(
										...
										'link'  => esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'wwptaxexemptionpopupbutton' ) ),
									),
									'tax_display'      => array(
										'title' => '<h4>' . __( 'Upgrade To Wholesale Suite For Advanced Tax Display', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
										'msg'   => '<p>' . __( 'Wholesale Suite is the #1 best rated wholesale solution for WooCommerce. Prices Premium (one of the three plugins) features in-depth tax display controls.', 'woocommerce-wholesale-prices-testing' ) . '</p>',
										'link'  => esc_url( WWP_Helper_Functions::get_utm_url( 'bundle', 'wwp', 'upsell', 'wwptaxdisplaypopupbutton' ) ),
									),
									'suffix_overrides' => array(
										'title' => '<h4>' . __( 'Upgrade To Wholesale Suite For Suffix Overrides', 'woocommerce-wholesale-prices-testing' ) . '</h4>',
										'msg'   => sprintf(
                                            // translators: %1$s - <p> tag, %2$s - </p> tag.
                                            __(
        ...
        private function load_wwp_prices_settings_for_non_wholesale_users_styles_and_scripts() {
            ...
            if ( empty( $wwlc_plugin_data ) ) {
                ...
                $admin_notice_message = '<a href="' . esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-lead-capture', 'wwp', 'upsell', 'wwlcshowtononwholesale' ) ) . '" target="_blank">' . __( 'Get WooCommerce Wholesale Lead Capture to unlock this powerful feature + more', 'woocommerce-wholesale-prices-testing' ) . '&rarr;</a>';
            ...
            wp_localize_script(
                ...
                array(
					...
					'wwp_price_settings_register_text_tooltip' => wc_help_tip( __( 'This text is linked to the defined registration page in WooCommerce Wholesale Lead Capture Settings.', 'woocommerce-wholesale-prices-testing' ) ),
					'wwp_see_wholesale_prices_replacement_text' => get_option( 'wwp_see_wholesale_prices_replacement_text' ),
					'wwp_see_wholesale_prices_replacement_text_tooltip' => wc_help_tip( __( 'The \'Click to See Wholesale Prices\' text seen in frontend.', 'woocommerce-wholesale-prices-testing' ) ),
					'wwp_wholesale_role_select_select2_tooltip' => wc_help_tip( __( 'The selected wholesale roles and pricing that should show to non-wholesale customers on the front end.', 'woocommerce-wholesale-prices-testing' ) ),
					'wholesale_role_data_placeholder_txt' => __( 'Choose wholesale role...', 'woocommerce-wholesale-prices-testing' ),
                     ...
                     */
					'i18n_show_wholesale_price_settings_title' => __( 'Show Wholesale Prices Box For Non Wholesale Customers', 'woocommerce-wholesale-prices-testing' ),
					'i18n_locations_title'                => __( 'Locations', 'woocommerce-wholesale-prices-testing' ),
					'i18n_click_to_see_wholesale_price_title' => __( 'Click to See Wholesale Prices Text', 'woocommerce-wholesale-prices-testing' ),
					'i18n_wholesale_role_title'           => __( 'Wholesale Roles(s)', 'woocommerce-wholesale-prices-testing' ),
					'i18n_register_title'                 => __( 'Register Text', 'woocommerce-wholesale-prices-testing' ),
					'i18n_locations_shop'                 => __( 'Shop Archives', 'woocommerce-wholesale-prices-testing' ),
					'i18n_locations_single_product'       => __( 'Single Product', 'woocommerce-wholesale-prices-testing' ),
					'i18n_locations_order_form'           => __( 'Wholesale Order Form', 'woocommerce-wholesale-prices-testing' ),
					...
					'i18n_wwof_inactive_notice'           => '<small>' . sprintf(
                        ...
                        __( 'To use this option, you must have %1$sWooCommerce Wholesale Order Form%2$s plugin installed and activated.', 'woocommerce-wholesale-prices-testing' ),
                        '<strong>',
                        '</strong>'
                    ) . '</small>',
                )
            ...
            if (
                ...
                if ( empty( $userWholesaleRole ) ) {
                    ...
                    wp_localize_script(
                        ...
                        'options',
                        array(
                            'popover_header_title' => apply_filters( 'wwp_popover_header_title', __( 'Wholesale Prices', 'woocommerce-wholesale-prices-testing' ) ),
...
?>
                    ...
                    echo wp_kses_post(
                        sprintf(
                            ...
                            sprintf(
                                '<a href="%s" target="_blank">',
                                esc_url(
                                    WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'wwprolespagelinkpopup' )
                                ),
                            ),
                            '</a>'
                        )
                ...
                <p>
                    <a class="button"
                        href="<?php echo esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'upsell', 'wwprolespagebuttonpopup' ) ); ?>"
                        target="_blank">
            ...
            if ( strpos( $current_screen->id, 'wholesale' ) !== false && ! WWP_Helper_Functions::is_wpay_active() ) {
                ...
                if ( ! empty( array_intersect( (array) $user->roles, $allowed_roles ) ) ) {
                    ...
                    $wpay_toolbar_label = sprintf(
                        ...
                        esc_attr__( 'Wholesale Payments', 'woocommerce-wholesale-prices-testing' ),
                        esc_attr__( 'Wholesale Payments', 'woocommerce-wholesale-prices-testing' ),
                    );
            ...
            if ( ! WWP_Helper_Functions::is_wpay_active() && $this->load_wwp_pointer() ) {
                ...
                <script>
                    jQuery(document).ready(function ($) {
                        const wpayToolBarHTML = '<h3><?php esc_html_e( 'Setup Wholesale Payments (Recommended)', 'woocommerce-wholesale-prices-testing' ); ?></h3><p><?php esc_html_e( 'Use Wholesale Suite Wholesale Payments plugin to create NET 30, 60, or any other invoice payment plan you can think of for your wholesale customers.', 'woocommerce-wholesale-prices-testing' ); ?></p><ul><li> <?php echo esc_html__( 'Turn WooCommerce orders into Stripe Invoices with NET payment terms', 'woocommerce-wholesale-prices-testing' ); ?> </li><li><?php echo esc_html__( 'Add a new "Wholesale Invoice" gateway', 'woocommerce-wholesale-prices-testing' ); ?> </li><li><?php echo esc_html__( 'Restrict to certain wholesale roles or even certain customers only', 'woocommerce-wholesale-prices-testing' ); ?></li><li><?php echo esc_html__( 'Create any kind of delayed payment plan (eg. NET 30, NET 60, % deposits, ...)', 'woocommerce-wholesale-prices-testing' ); ?></li><li><?php echo esc_html__( 'Expert worldwide support', 'woocommerce-wholesale-prices-testing' ); ?></li></ul><a href="<?php echo esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-payments', 'wwp', 'upsell', 'upgradepagewpaylearnmore' ) ); ?>" target="_blank" class="button button-primary"><span><?php echo esc_html__( 'Get Wholesale Payments' ); ?></span></a>';
        ...
        public function run() {
            ...
            register_activation_hook( WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-prices-testing' . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-prices-testing.bootstrap.php', array( $this, 'wwp_activate' ) );
        }
    }
}
