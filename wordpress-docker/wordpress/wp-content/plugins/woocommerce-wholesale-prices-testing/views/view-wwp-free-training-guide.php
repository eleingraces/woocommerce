...
<div id="wwp-free-training-guide" class="wwp-page wrap nosubsub">
    <div class="row-container free-guide">
        <div class="page-title">
            <?php esc_html_e( 'FREE GUIDE: How To Setup Wholesale On Your WooCommerce Store', 'woocommerce-wholesale-prices-testing' ); ?>
        </div>
        <div class="two-columns">
            <div class="left-box">
                <div class="page-title">
                    <?php esc_html_e( 'A Step-By-Step Guide For Adding Wholesale Ordering To Your Store', 'woocommerce-wholesale-prices-testing' ); ?>
                </div>
                <p>
                    <?php
                        echo wp_kses_post(
                ...
                <ul>
                    <li><span class="dashicons dashicons-lightbulb"></span><?php esc_html_e( 'Learn exactly how to price your products ready for wholesale', 'woocommerce-wholesale-prices-testing' ); ?></li>
                ...
                <a href="<?php echo esc_url( WWP_Helper_Functions::get_utm_url( 'free-guide', 'wwp', 'settings', 'generalsettingfreeguidebutton' ) ); ?>" target="_blank" class="button-green"><?php esc_html_e( 'Get FREE Training Guide', 'woocommerce-wholesale-prices-testing' ); ?></a>
            </div>
            <div class="right-box">
