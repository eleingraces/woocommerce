...
<div id="wws_settings_wwp" class="wws_license_settings_page_container">
    ...
    <div id="wwp_wws_upgrade_to_premium_upsell" class="wws-license-manager-upsell-upgrade-to-premium-container">
        ...
        <div class="content-header">
            <h1><?php esc_html_e( 'Get Wholesale Prices Premium', 'woocommerce-wholesale-prices-testing' ); ?></h1>
            <span>
                <?php
                // translators: %1$s <strong> tag, %2$s </strong> tag.
                echo wp_kses_post( sprintf( __( 'Currently using: %1$sFree Version%2$s', 'woocommerce-wholesale-prices-testing' ), '<strong>', '</strong>' ) );
                ?>
            </span>
        </div>
        ...
        <div class="content-body">
            <div class="row-content">
                ...
                <div class="col-content">
                    <p><?php esc_html_e( 'Wholesale Prices Premium gives you a massive range of extra wholesale features for pricing, tax, shipping, payment, user roles, product visibility & more. Premium functions as an add-on to Wholesale Prices Free so you need to have that installed & activate.', 'woocommerce-wholesale-prices-testing' ); ?></p>
                    ...
                    <p><a
                            class="action-button"
                            href="<?php echo esc_url( WWP_Helper_Functions::get_utm_url( 'woocommerce-wholesale-prices-testing-premium', 'wwp', 'licensepage', 'WWPPlicenseupsell' ) ); ?>"
                            target="_blank"
                        ><?php esc_html_e( 'Get Wholesale Suite', 'woocommerce-wholesale-prices-testing' ); ?></a></p>
                </div>
            </div>
        </div>
