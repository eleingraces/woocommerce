...
if ( ! class_exists( 'WWP_Order' ) ) {
    ...
    class WWP_Order {
        ...
        public function add_orders_listing_custom_column( $columns ) {
            ...
            $columns['wwpp_order_type'] = __( 'Order Type', 'woocommerce-wholesale-prices-testing' );
        ...
        public function add_orders_listing_custom_column_content( $column, $post_id ) {
            if ( 'wwpp_order_type' === $column ) {
                ...
                if ( '' === $order_type || null === $order_type || false === $order_type || 'retail' === $order_type ) {
                    ...
                    esc_html_e( 'Retail', 'woocommerce-wholesale-prices-testing' );
                    ...
                    if ( isset( $all_registered_wholesale_roles[ $wholesale_order_type ] ) && ! empty( $all_registered_wholesale_roles[ $wholesale_order_type ]['roleName'] ) ) {
                        ...
                        echo esc_html( sprintf( __( 'Wholesale (%1$s)', 'woocommerce-wholesale-prices-testing' ), $all_registered_wholesale_roles[ $wholesale_order_type ]['roleName'] ) );

                        if ( ! WWP_Helper_Functions::is_wwpp_active() && 'wholesale_customer' !== $wholesale_order_type ) {
                            echo wp_kses_post( wc_help_tip( __( 'This wholesale role is exclusive only for Wholesale Prices Premium. Make sure the plugin is active.', 'woocommerce-wholesale-prices-testing' ) ) );
                        }
                    }
                }
            }
        ...
        public function add_wholesale_role_order_listing_filter( $order_type = null, $which = null ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
            ...
            if ( 'shop_order' === $screen ) {
                ...
                $all_registered_wholesale_roles = array( 'all_wholesale_orders' => array( 'roleName' => __( 'All Wholesale Orders', 'woocommerce-wholesale-prices-testing' ) ) ) + $all_registered_wholesale_roles;
                $all_registered_wholesale_roles = array( 'all_retail_orders' => array( 'roleName' => __( 'All Retail Orders', 'woocommerce-wholesale-prices-testing' ) ) ) + $all_registered_wholesale_roles;
                $all_registered_wholesale_roles = array( 'all_order_types' => array( 'roleName' => __( 'Show all order types', 'woocommerce-wholesale-prices-testing' ) ) ) + $all_registered_wholesale_roles;
                ?>
        ...
        public function run() {
            ...
            if ( is_plugin_inactive( 'woocommerce-wholesale-prices-testing-premium/woocommerce-wholesale-prices-testing-premium.bootstrap.php' ) && ! class_exists( 'WooCommerceWholeSalePricesPremium' ) ) {
