        ...
        public function install_acfwf_note() {
            ...
            if (
                ...
                try {
                    ...
                    $note->set_title( __( 'Install Advanced Coupons (FREE PLUGIN)', 'woocommerce-wholesale-prices-testing' ) );
                    $note->set_content( $note_content );
                    $note->set_content_data( (object) array() );
                    $note->set_type( $note::E_WC_ADMIN_NOTE_INFORMATIONAL );
                    $note->set_name( self::NOTE_NAME );
                    $note->set_source( 'woocommerce-admin' );
                    $note->add_action( 'install-acfw', __( 'Install Now', 'woocommerce-wholesale-prices-testing' ), $install_acfw_url, $note::E_WC_ADMIN_NOTE_ACTIONED, true );
                    $note->add_action( 'learn-about-acfw', __( 'Learn more', 'woocommerce-wholesale-prices-testing' ), $learn_more, $note::E_WC_ADMIN_NOTE_UNACTIONED, false );
                    $note->save();
