...
if ( ! class_exists( 'WWP_WWS_License_Manager' ) ) {
    ...
    class WWP_WWS_License_Manager {
        ...
        public function register_ms_wws_licenses_settings_menu() {
            add_menu_page(
                __( 'WWS License', 'woocommerce-wholesale-prices-testing' ),
                __( 'WWS License', 'woocommerce-wholesale-prices-testing' ),
                'manage_sites',
        ...
        public function register_wws_license_settings_menu() {
            ...
            add_submenu_page(
                ...
                __( 'License', 'woocommerce-wholesale-prices-testing' ),
                __( 'License', 'woocommerce-wholesale-prices-testing' ),
                'manage_woocommerce',
        ...
        public function wwpp_license_tab() {
			...
			<a href="<?php echo wp_kses_post( $wwp_license_settings_url ); ?>" class="nav-tab <?php echo ( 'wwpp' === $tab ) ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Wholesale Prices', 'woocommerce-wholesale-prices-testing' ); ?></a>
        ...
        public function wwof_license_tab() {
            ...
            <a href="<?php echo wp_kses_post( $wwof_license_settings_url ); ?>" class="nav-tab <?php echo ( 'wwof' === $tab ) ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Wholesale Ordering', 'woocommerce-wholesale-prices-testing' ); ?></a>
        ...
        public function license_tab_and_contents() {
            ...
            if ( ! WWP_Helper_Functions::is_wwpp_active() ) {
                 ...
                 */
                $wwpp_plugin_data = get_plugin_data( WP_PLUGIN_DIR . '/woocommerce-wholesale-prices-testing-premium/woocommerce-wholesale-prices-testing-premium.bootstrap.php', false, false );
