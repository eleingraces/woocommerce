...
class WWP_Wholesale_Prices_For_Non_Wholesale_Customers {
    ...
    private function _process_product_wholesale_price( $price_html, $role_name ) {
        $wholesale_price_title_text = trim( apply_filters( 'wwp_filter_wholesale_price_title_text', __( 'Wholesale Price:', 'woocommerce-wholesale-prices-testing' ) ) );
    ...
    public function registration_text_filter() {
        ...
        return apply_filters( 'wwp_non_wholesale_registration_text_filter', empty( $registration_text ) ? __( 'Click here to register as a wholesale customer', 'woocommerce-wholesale-prices-testing' ) : $registration_text );
    }
    ...
    public function display_replacement_message_to_non_wholesale( $product = null ) {
        ...
        $message = apply_filters( 'wwp_display_non_wholesale_replacement_message', empty( $replacement_text ) ? __( 'See wholesale prices', 'woocommerce-wholesale-prices-testing' ) : $replacement_text );
