...
<div id="wws_settings_wwp" class="wws_license_settings_page_container">
    ...
    <div id="wwlc_wws_upgrade_to_premium_upsell" class="wws-license-manager-upsell-upgrade-to-premium-container">
        ...
        <div class="content-header">
            <h1><?php esc_html_e( 'Get Wholesale Lead Capture', 'woocommerce-wholesale-prices-testing' ); ?></h1>
        </div>
        ...
        <div class="content-body">
            <div class="row-content">
                ...
                <div class="col-content">
                    <p><?php esc_html_e( 'Wholesale Lead Capture provides a dedicated wholesale registration & login form for your wholesale customers, a full featured user approvals system, and email sequences so you can capture and onboard new wholesale customers with ease.', 'woocommerce-wholesale-prices-testing' ); ?></p>
