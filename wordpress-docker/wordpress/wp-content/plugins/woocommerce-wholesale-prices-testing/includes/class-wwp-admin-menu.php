    ...
    class WWP_Admin_Menu {
        ...
        public function register_page() {
            ...
            if ( ! empty( array_intersect( (array) $user->roles, $allowed_roles ) ) ) {
                ...
                $dashboard_label = $wc_wholesale_prices->wwp_dashboard->is_wholesale_dashboard_disabled() ? __( 'Dashboard (Disabled)', 'woocommerce-wholesale-prices-testing' ) : __( 'Dashboard', 'woocommerce-wholesale-prices-testing' );

                // Wholesale Top Level Menu.
                add_menu_page( __( 'Wholesale', 'woocommerce-wholesale-prices-testing' ), __( 'Wholesale', 'woocommerce-wholesale-prices-testing' ), 'manage_woocommerce', 'wholesale-suite', array( $this, 'wholesale_dashboard' ), $wws_icon, '55.5' );
                ...
                if ( WWP_Helper_Functions::is_plugin_active( 'woocommerce-wholesale-prices-testing-premium/woocommerce-wholesale-prices-testing-premium.bootstrap.php' ) ) {
                    add_submenu_page( 'wholesale-suite', __( 'Reports', 'woocommerce-wholesale-prices-testing' ), __( 'Reports', 'woocommerce-wholesale-prices-testing' ), 'manage_woocommerce', 'wholesale-reports', array( $this, 'wholesale_reports' ), 5 );
                }

                // Orders Submenu.
                add_submenu_page( 'wholesale-suite', __( 'Orders', 'woocommerce-wholesale-prices-testing' ), __( 'Orders', 'woocommerce-wholesale-prices-testing' ), 'manage_woocommerce', 'wholesale-orders', array( $this, 'wholesale_orders' ), 1 );

                // Settings Submenu.
                add_submenu_page( 'wholesale-suite', __( 'Settings', 'woocommerce-wholesale-prices-testing' ), __( 'Settings', 'woocommerce-wholesale-prices-testing' ), 'manage_woocommerce', 'wholesale-settings', array( $this, 'wholesale_settings' ), 5 );
        ...
        public function wholesale_settings() {
            ...
            echo '<h1 class="wwp-settings-heading" style="font-size: 26px; font-weight: 700;">' . esc_html__( 'Settings', 'woocommerce-wholesale-prices-testing' ) . '</h1>';
